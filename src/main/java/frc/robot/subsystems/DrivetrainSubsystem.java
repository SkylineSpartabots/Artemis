...
public class DrivetrainSubsystem extends SubsystemBase {
    ...
    public DrivetrainSubsystem() {
        ...
        m_odometry = new SwerveDriveOdometry(DriveConstants.kDriveKinematics, getGyroscopeRotation(), getModulePositions());
    ...
    public void resetOdometry() {
        ...
        m_odometry.resetPosition(new Rotation2d(0), getModulePositions(), new Pose2d());
    }
    ...
    public void resetOdometryFromPosition(double x, double y, double rot) {
        ...
        m_odometry.resetPosition( new Rotation2d(rot), new SwerveModulePosition[] {}, new Pose2d(x, y, new Rotation2d(rot)));
    }

    //resets from offset
    public void resetOdometryFromPosition(double x, double y) {
        m_odometry.resetPosition( getGyroscopeRotation(), new SwerveModulePosition[] {}, new Pose2d(x, y, getGyroscopeRotation()));
    }

    public void resetOdometryFromPosition(Pose2d pose) {
        m_navx.reset();
        m_navx.setAngleAdjustment(-pose.getRotation().getDegrees());
        m_odometry.resetPosition(pose.getRotation(), new SwerveModulePosition[] {}, pose);
    }
